<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"./themes/admin/auth_group\add.html";i:1490664232;s:24:"./themes/admin/base.html";i:1492572933;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/auth_group/save'); ?>" method="post">
