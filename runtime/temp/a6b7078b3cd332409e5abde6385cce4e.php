<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"./themes/admin/auth_group\auth.html";i:1490664232;s:24:"./themes/admin/base.html";i:1492572933;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            url: "<?php echo url('admin/auth_group/getJson'); ?>",
            type: "post",
            dataType: "json",
            cache: false,
            data: {
        ...
        $("#auth-btn").on("click", function () {
            ...
            $.ajax({
                url: "<?php echo url('admin/auth_group/updateAuthGroupRule'); ?>",
                type: "post",
                cache: false,
                data: {
                    id: _id,
